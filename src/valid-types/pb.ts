...
// @generated from file validate/minimal-validate.proto (package buf.validate, syntax proto2)
/* eslint-disable */
...
/**
 * Describes the file validate/minimal-validate.proto.
 */
export const file_validate_minimal_validate: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
...
export const MessageRulesSchema: GenMessage<MessageRules, { validType: MessageRulesValid }> =
  /*@__PURE__*/
  messageDesc(file_validate_minimal_validate, 0);
...
export const OneofRulesSchema: GenMessage<OneofRules, { validType: OneofRulesValid }> =
  /*@__PURE__*/
  messageDesc(file_validate_minimal_validate, 1);
...
export const FieldRulesSchema: GenMessage<FieldRules, { validType: FieldRulesValid }> =
  /*@__PURE__*/
  messageDesc(file_validate_minimal_validate, 2);
...
export const RepeatedRulesSchema: GenMessage<RepeatedRules, { validType: RepeatedRulesValid }> =
  /*@__PURE__*/
  messageDesc(file_validate_minimal_validate, 3);
...
export const MapRulesSchema: GenMessage<MapRules, { validType: MapRulesValid }> =
  /*@__PURE__*/
  messageDesc(file_validate_minimal_validate, 4);
...
export const IgnoreSchema: GenEnum<Ignore> =
  /*@__PURE__*/
  enumDesc(file_validate_minimal_validate, 0);
...
export const message: GenExtension<MessageOptions, MessageRules> =
  /*@__PURE__*/
  extDesc(file_validate_minimal_validate, 0);
...
export const oneof: GenExtension<OneofOptions, OneofRules> =
  /*@__PURE__*/
  extDesc(file_validate_minimal_validate, 1);
...
export const field: GenExtension<FieldOptions, FieldRules> =
  /*@__PURE__*/
  extDesc(file_validate_minimal_validate, 2);
